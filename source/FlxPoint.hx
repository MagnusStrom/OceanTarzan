...
class FlxPoint implements IFlxPooled
{
	...
	public function multiplyPoint(point:FlxPoint):FlxPoint
	{
		multiplyPointWeak(point);
		point.putWeak();
		return this;
	}

	public function multiplyBy(num:Int):FlxPoint
	{
		x *= num;
		y *= num;
		return this;
	...
	inline function multiplyPointWeak(point:FlxPoint):FlxPoint
	{
		x *= point.x;
		y *= point.y;
		return this;
	...
	/**
	 * Subtracts the coordinates of another point from the coordinates of this point.n
	 *
	...
	public function divideBy(num:Int):FlxPoint
	{
		dividePointWeak(num);
		return this;
	}
	...
	inline function dividePointWeak(num):FlxPoint
	{
		x /= num;
		y /= num;
		return this;
